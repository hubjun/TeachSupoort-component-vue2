        ...
        <el-table-column align="center" label="操作">
          <template slot-scope="scope">
            <div>
              ...
              <template v-else>
                <el-button
                  @click="disable(false,scope.row.id)"
...
import { getDictionary, disableDictionary } from './api'
      ...
      searchConfig: {
        ...
        config: [
          ...
          },
          {
            ...
            labelWidth: '0',
            prop: 'name',
            placeholder: '请输入选用方式编码/名称/拼音码/五笔码',
            type: 'text'
          }
        ]
      },
