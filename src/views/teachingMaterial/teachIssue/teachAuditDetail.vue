<template>
  <div id="teachAuditDetail" ref="teachAuditDetail" class="com-detail-wrap">
...
export default {
  ...
  methods: {
    ...
    getTableHeight() {
      const teachAuditDetail = document.getElementById('teachAuditDetail')
        .clientHeight
      let detailItem = document
        .getElementById('teachAuditDetail')
      ...
      this.Form.tableHeight =
        teachAuditDetail - detailItem - detailHead  - 60 - 22 // 60为table-box的内边距，两个20位margin-bottom
    },
    cancel() {
      this.$router.go(-1)
    },
