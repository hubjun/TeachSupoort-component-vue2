<template>
  <div id="manyAudit" ref="manyAudit">
...
export default {
  ...
  methods: {
    getTableHeight() {
      const manyAudit = document.getElementById('manyAudit').clientHeight
      let searchBox = document
        .getElementById('manyAudit')
      ...
      this.tableConfig.tableHeight =
        manyAudit - searchBox - pagination - 40 - 10 // 40为table-box的内边距，两个20位margin-bottom
    },
    handleSearch() {
