<template>
  <div id="AllocationConfirmDetail" ref="AllocationConfirmDetail" class="com-detail-wrap">
    <div class="detail-item">
      <div class="detail-head">
        <div class="tit">基本信息</div>
        <div class="btns">
          <el-button class="com-btn" type="info" @click="cancel" plain>返回</el-button>
          <el-button class="com-btn" type="primary" v-if="formData.allocateStatus === 2" @click="confirm" plain>审核</el-button>
          <el-button class="com-btn" type="danger" v-if="formData.allocateStatus === 2" @click="unpass" plain>驳回</el-button>
        </div>
      </div>
...
<script>
  ...
  import { getApplyDetail, toConfirm, toReject } from './api';
  ...
  export default {
    ...
    data() {
      return {
        listPath: '/teachasset/asset-allocation/allocation-confirm',
        // 页面类型
        type: 'detail',
        // 基础表单是否禁用
        disabled: false,
