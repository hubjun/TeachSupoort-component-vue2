<template>
  <div id="AllocationApply" ref="AllocationApply">
    <search-bar
...
<!--          <template slot-scope="scope">-->
<!--            <div>-->
<!--              <el-button class="font-color-blue" v-if="scope.row.allocateStatus === 1" type="text" @click.stop="edit(scope.row)">编辑</el-button>-->
<!--            </div>-->
<!--          </template>-->
<!--        </el-table-column>-->
      </table-list>
...
<script>
  ...
  export default {
    ...
    data() {
      return {
        detailPath: '/teachasset/asset-allocation/allocation-apply-detail',
        // 搜索按钮加载
        isLoading: false,
        // 搜索栏配置
        searchConfig: {
    ...
    methods: {
      // 动态设置表格高度
      getTableHeight() {
        const assetAccept = document.getElementById('AllocationApply').clientHeight
        let searchBox = document
          .getElementById('AllocationApply')
