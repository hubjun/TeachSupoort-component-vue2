  ...
  export default {
    ...
    methods: {
      ...
      dblclick(row, column, cell, event) {
        this.$router.push({ path: '/teachasset/purchase-plan/purchase-plan-audit-detail', query: { type: 'edit', id: row.id } })
      },
      // 计算表格高度
      getTableHeight() {
      ...
      // 点击新增
      addData() {
        this.$router.push({ path: '/teachasset/purchase-plan/purchase-plan-audit-detail', query: { type: 'add' } })
      },
      // 查询数据列表
      getList() {
        ...
        let param = {
          ...
          purchaseEnd: this.searchConfig.data.startEnd[1],
          purchaseStart: this.searchConfig.data.startEnd[0],
